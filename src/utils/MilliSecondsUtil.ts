...
export function calculateSnaps(
  bpm: number,
  customNumerator: number = 0,
  customDenominator: number = 0
  ...
  return {
    ...
    custom: customDenominator === 0 ? 0 : (customNumerator * oneMeasureMs) / customDenominator // custom snapping, avoiding division by 0
  }
}
